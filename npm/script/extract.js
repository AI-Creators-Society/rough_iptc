...
exports.extractChunks = void 0;
const mod_js_1 = require("./deps/deno.land/x/crc32@v0.2.2/mod.js");
...
const extractChunks = (data) => {
    ...
    while (idx < data.length) {
        ...
        const crcExpect = parseInt((0, mod_js_1.crc32)(chunk), 16);
